...
// Struktur data untuk sistem
typedef struct {
    User users[MAX_USERS];
    int userCount;
    char currentSession[MAX_LENGTH]; // Username dari sesi login aktif
} System;
...
// Fungsi membaca input dari stdin
...
// Fungsi mengecek apakah username sudah ada
...
// Fungsi mencari pengguna berdasarkan username dan password
...
void logout(System *system) {
    ...
    system->currentSession[0] = '\0'; // Menghapus sesi aktif
}
